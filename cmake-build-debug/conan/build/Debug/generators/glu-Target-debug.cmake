...
########## GLOBAL TARGET PROPERTIES Debug ########################################
    ...
    set_property(TARGET glu::glu
                 ...
                 $<$<CONFIG:Debug>:${glu_LINKER_FLAGS_DEBUG}> APPEND)
    set_property(TARGET glu::glu
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Debug>:${glu_INCLUDE_DIRS_DEBUG}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET glu::glu
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Debug>:${glu_LIB_DIRS_DEBUG}> APPEND)
    set_property(TARGET glu::glu
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Debug>:${glu_COMPILE_DEFINITIONS_DEBUG}> APPEND)
    set_property(TARGET glu::glu
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Debug>:${glu_COMPILE_OPTIONS_DEBUG}> APPEND)
